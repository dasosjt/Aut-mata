...
\item 
vector$<$ \hyperlink{structvertex}{vertex} $\ast$$>$ \hyperlink{class_a_f_d_x_a333de4006f306b7ebfa295b95ebb6626}{search\+For\+Belong} (vector$<$ vector$<$ \hyperlink{structvertex}{vertex} $\ast$ $>$ $>$ PI, int state)
...
\index{A\+F\+DX@{A\+F\+DX}!search\+For\+Belong@{search\+For\+Belong}}
\index{search\+For\+Belong@{search\+For\+Belong}!A\+F\+DX@{A\+F\+DX}}
